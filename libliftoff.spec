...
Source0  : https://gitlab.freedesktop.org/emersion/libliftoff/-/archive/v0.5.0/libliftoff-v0.5.0.tar.gz
...
%prep
%setup -q -n libliftoff-v0.5.0
cd %{_builddir}/libliftoff-v0.5.0
pushd ..
cp -a libliftoff-v0.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720112391
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libliftoff.so.0.5.0
